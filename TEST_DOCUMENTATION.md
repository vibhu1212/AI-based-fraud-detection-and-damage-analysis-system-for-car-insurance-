...
|---------|--------|---------|---------------|------------------|--------|
| TC-M0-01 | M0 | Quality Gate | Upload blurred image | API rejects with status 400 and reason 'Blur threshold exceeded' | Planned |
| TC-M0-02 | M0 | PII Masking | Upload image with visible license plate | API returns image with plate area blurred/blacked out | Planned |
...
| TC-M6-01 | M6 | ICVE Pricing | Submit valid parts calculation request | Returns calculated total including correct depreciation and labor | Planned |
